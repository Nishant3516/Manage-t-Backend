...
/**
 * Criteria class for the {@link com.ssik.manageit.domain.StudentClassWorkTrack} entity. This class is used
 * in {@link com.ssik.manageit.web.rest.StudentClassWorkTrackResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /student-class-work-tracks?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class StudentClassWorkTrackCriteria implements Serializable, Criteria {
    ...
    public StudentClassWorkTrackCriteria() {}

    public StudentClassWorkTrackCriteria(StudentClassWorkTrackCriteria other) {
    ...
    @Override
    public StudentClassWorkTrackCriteria copy() {
        return new StudentClassWorkTrackCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final StudentClassWorkTrackCriteria that = (StudentClassWorkTrackCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, workStatus, remarks, createDate, lastModified, cancelDate, classStudentId, classClassWorkId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "StudentClassWorkTrackCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
