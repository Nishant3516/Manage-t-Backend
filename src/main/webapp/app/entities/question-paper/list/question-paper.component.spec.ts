...
describe('QuestionPaper Management Component', () => {
  let comp: QuestionPaperComponent;
  let fixture: ComponentFixture<QuestionPaperComponent>;
  let service: QuestionPaperService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'question-paper', component: QuestionPaperComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(QuestionPaperComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.questionPapers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
