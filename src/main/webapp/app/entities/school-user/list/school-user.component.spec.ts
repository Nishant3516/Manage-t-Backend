...
describe('Component Tests', () => {
  describe('SchoolUser Management Component', () => {
    let comp: SchoolUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SchoolUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.schoolUsers?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
