...
describe('Component Tests', () => {
  describe('ClassStudent Management Component', () => {
    let comp: ClassStudentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClassStudentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.classStudents?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
