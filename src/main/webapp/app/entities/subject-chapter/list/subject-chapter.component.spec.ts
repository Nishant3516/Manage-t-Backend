...
describe('Component Tests', () => {
  describe('SubjectChapter Management Component', () => {
    let comp: SubjectChapterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubjectChapterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.subjectChapters?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
