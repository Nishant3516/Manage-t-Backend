...
@Component({
  selector: 'jhi-school-notifications',
  templateUrl: './school-notifications.component.html',
})
export class SchoolNotificationsComponent implements OnInit {
  ...
  delete(schoolNotifications: ISchoolNotifications): void {
    const modalRef = this.modalService.open(SchoolNotificationsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.schoolNotifications = schoolNotifications;
