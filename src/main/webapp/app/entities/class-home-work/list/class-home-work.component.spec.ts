...
describe('Component Tests', () => {
  describe('ClassHomeWork Management Component', () => {
    let comp: ClassHomeWorkComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClassHomeWorkComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.classHomeWorks?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
