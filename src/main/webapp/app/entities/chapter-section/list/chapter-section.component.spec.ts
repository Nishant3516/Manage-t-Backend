...
describe('Component Tests', () => {
  describe('ChapterSection Management Component', () => {
    let comp: ChapterSectionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChapterSectionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chapterSections?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
