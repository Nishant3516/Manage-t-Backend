...
describe('Component Tests', () => {
  describe('ClassSubject Management Component', () => {
    let comp: ClassSubjectComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClassSubjectComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.classSubjects?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
