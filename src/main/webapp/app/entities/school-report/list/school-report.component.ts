...
export class SchoolReportComponent implements OnInit {
  ...
  delete(schoolReport: ISchoolReport): void {
    const modalRef = this.modalService.open(SchoolReportDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ISchoolReport[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
